...
1. The integer is converted to its Zeckendorf representation (list of Fibonacci indices)
1. The representation is encoded as bits (use/skip bits)
1. Bits are packed into bytes (little-endian output)
